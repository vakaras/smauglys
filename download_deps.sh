...
try_download_package 'https://github.com/vakaras/smauglys/blob/debug-visualizer/vscode_extensions/hediet.debug-visualizer.vsix?raw=true' 'vscode_extensions/hediet.debug-visualizer.vsix' '05fb840a95f55d45866596970416a522'
