...
Section "Uninstaller creation"
  ...
  Rename "$PROGRAMFILES64\LR NSA Python\unins000.exe" "$PROGRAMFILES64\LR NSA Python\unins000-orig.exe"
  Rename "$PROGRAMFILES64\LR NSA Python\unins000.dat" "$PROGRAMFILES64\LR NSA Python\unins000-orig.dat"
  WriteUninstaller "$PROGRAMFILES64\LR NSA Python\unins000.exe"
...
Section "Remove temp files" SEC03
  ...
  StrCpy $0 "$PROGRAMFILES64\LR NSA Python\install.log"
  Push $0
  Call DumpLog
...
; -----------------------------------------------
Section "Uninstall"
  delete /REBOOTOK "$PROGRAMFILES64\LR NSA Python\install.log"
  delete /REBOOTOK "$DESKTOP\Python Documentation.lnk"
  delete /REBOOTOK "$PROGRAMFILES64\LR NSA Python\unins000.exe"
  ExecWait '"$PROGRAMFILES64\LR NSA Python\unins000-orig.exe" /SILENT'
  RMDir /REBOOTOK "$PROGRAMFILES64\LR NSA Python"
  EnVar::SetHKLM
